...
namespace AlvarezInmobiliaria.Models
{
       ...
       public List<Pago> ObtenerPagos()
    {
        ...
        {
            var query = @"SELECT p.Id, NumeroPago, Fecha, Importe, ContratoId, c.InquilinoId, c.InmuebleId, inq.Nombre, inq.Apellido, i.Direccion
    ...
    public int Alta(Pago pago)
    {
         ...
         using(MySqlConnection conn = new MySqlConnection(connectionString))
         {
            var query = @"INSERT INTO pago (NumeroPago, Fecha, Importe, ContratoId) 
    ...
    public Pago ObtenerPorId(int id)
    {
        ...
        using(MySqlConnection conn = new MySqlConnection(connectionString))
        {
            var query = @"SELECT p.Id, NumeroPago, Fecha, Importe, ContratoId, c.InquilinoId, inq.Nombre, inq.Apellido, c.InmuebleId, inm.Direccion 
                          FROM pago p JOIN contrato c ON p.ContratoId = c.Id
